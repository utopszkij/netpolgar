...
<?php endif; ?>
            ...
            <div class="flex items-center justify-end mt-4">
            	<a class="underline text-sm text-gray-600 hover:text-gray-900" 
            	   ...
            	   <?php echo e(__('Not accounts? - register')); ?>
            ...
            <div class="flex items-center justify-end mt-4">
                <button type="submit" class="btn btn-primary">
                    <em class="fa fa-check"></em>&nbsp;<?php echo e(__('Login')); ?>

                </button>&nbsp;    
                <a class="btn btn-secondary" href="<?php echo e(url('/')); ?>">
                    <em class="fas fa-undo-alt"></em>&nbsp;<?php echo e(__('backHome')); ?>
            ...
            <div class="flex items-center justify-end mt-4">
                <a class="btn" href="<?php echo e(url('auth/facebook')); ?>"
                    ...
                    <em class="fab fa-facebook"></em>&nbsp;<?php echo e(__('Login with Facebook')); ?>
            ...
            <div class="flex items-center justify-end mt-4" style="display:none">
                <a class="btn" href="<?php echo e(url('auth/github')); ?>"
                    style="background: silver; color: black; padding: 10px; width: 100%; text-align: center; display: block; border-radius:3px;">
                    <em class="fab fa-github"></em>&nbsp;<?php echo e(__('Login with Github')); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php /**PATH /var/www/html/netpolgar/resources/views/auth/login.blade.php ENDPATH**/ ?>