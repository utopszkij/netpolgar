...
<?php $component->withAttributes([]); ?>  
    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
            	 <?php if($team->id > 0): ?>
                <h2>Csoport módosítása</h2>
                <?php else: ?>
                <h2>Új csoport javaslat</h2>
                <?php endif; ?>
            </div>
        </div>
    </div>
   ...
   <?php echo csrf_field(); ?>
	...
	<?php endif; ?>   
         ...
         <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <label style="vertical-align: top;">Leírás:</label>
                ...
                <div class="form-group">
                  <label style="vertical-align: top;">Beállítások:</label>
						<div class="config" style="display:inline-block; width:500px">
						  ...
						  <input type="number" min="1" max="100" 
						  name="debateAcivate" value="<?php echo e($team->config->debateActivate); ?>" />
	         ...
	         <div class="row">
	            <div class="col-xs-12 col-sm-12 col-md-12 text-center">
	              ...
	              <a class="btn btn-secondary" href="<?php echo e(route('parents.teams.index',["parent" => $team->parent])); ?>">
	                  <em class="fas fa-ban"></em>Mégsem</a>
	            </div>
	         </div>  
        </div>
...
<?php endif; ?>  
<?php /**PATH /var/www/html/netpolgar/resources/views/teams/form.blade.php ENDPATH**/ ?>