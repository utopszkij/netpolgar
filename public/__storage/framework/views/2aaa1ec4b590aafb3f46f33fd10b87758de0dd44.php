...
<?php endif; ?>
            ...
            <div class="flex items-center justify-end mt-4">
                <button type="submit" class="btn btn-primary">
                    <em class="fa fa-check"></em>&nbsp;<?php echo e(__('Register')); ?>

                </button>&nbsp;
                <a class="btn btn-secondary" href="<?php echo e(url('/')); ?>">
                    <em class="fa fa-undo-alt"></em>&nbsp;<?php echo e(__('backHome')); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php /**PATH /var/www/html/netpolgar/resources/views/auth/register.blade.php ENDPATH**/ ?>