 <footer id="footer">
        ...
        <div class="row footer-info">
				...
				<div class="col-sm-6  footer-links">
					...
					<li><i class="bx bx-chevron-right"></i>
						<a href="<?php echo e(\URL::to('/policy')); ?>">
						<?php echo e(__('footer.privacy-policy')); ?>

						</a>
					</li>
					<li><i class="bx bx-chevron-right"></i>
						<a href="<?php echo e(\URL::to('/terms')); ?>">
						<?php echo e(__('footer.term-of-service')); ?>
	...
	<div id="cookieEnable" style="display:none">
		<?php echo e(__('footer.enableLabel')); ?>

		&nbsp;		
		<a href="<?php echo e(\URL::to('/policy')); ?>" style="color:blue">
		<?php echo e(__('footer.seeThis')); ?>

		</a>
		<br />	
		<a class="btn btn-secondary" href="<?php echo e(URL::to('/')); ?>" 
			onclick="setCookie('netpolgarCookieEnable',1,20)">
			<?php echo e(__('footer.enableBtn')); ?>

		</a>
	</div>
	<div id="cookieDisable" style="display:none">
		<?php echo e(__('footer.disableLabel')); ?>

		<a class="btn btn-secondary"  href="<?php echo e(URL::to('/')); ?>" 
			onclick="setCookie('netpolgarCookieEnable',0,20)">
			<?php echo e(__('footer.disableBtn')); ?>
...
<?php /**PATH /var/www/html/netpolgar/resources/views/footer.blade.php ENDPATH**/ ?>