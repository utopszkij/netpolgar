		<!-- htmlhead.blade   Nunito, fontAwesome5.15.2 font, bootstrap5.0.0, jQuery3.6.0 -->
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1">
		<link href="<?php echo e(url('/')); ?>/img/logo.png" rel="icon">
...
<?php /**PATH /var/www/html/netpolgar/resources/views/layouts/htmlhead.blade.php ENDPATH**/ ?>